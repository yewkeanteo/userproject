...
#include "ToRORddynClmidCvodeOpt.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
class CellToRORddynClmidFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellToRORddynClmidFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellToRORddynClmidFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellToRORddynClmidFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellToRORddynClmidFromCellMLCvodeOpt_LookupTables()
    {
        if (_lookup_table_0)
        {
            delete[] _lookup_table_0;
...
protected:
    CellToRORddynClmidFromCellMLCvodeOpt_LookupTables(const CellToRORddynClmidFromCellMLCvodeOpt_LookupTables&);
    CellToRORddynClmidFromCellMLCvodeOpt_LookupTables& operator= (const CellToRORddynClmidFromCellMLCvodeOpt_LookupTables&);
    CellToRORddynClmidFromCellMLCvodeOpt_LookupTables()
    {
        ...
        _lookup_table_0 = NULL;
        CellToRORddynClmidFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellToRORddynClmidFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellToRORddynClmidFromCellMLCvodeOpt_LookupTables> CellToRORddynClmidFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellToRORddynClmidFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellToRORddynClmidFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    CellToRORddynClmidFromCellMLCvodeOpt::CellToRORddynClmidFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                45,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellToRORddynClmidFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    CellToRORddynClmidFromCellMLCvodeOpt::~CellToRORddynClmidFromCellMLCvodeOpt()
    {
    }
    
    AbstractLookupTableCollection* CellToRORddynClmidFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellToRORddynClmidFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double CellToRORddynClmidFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellToRORddynClmidFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellToRORddynClmidFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
    ...
    void CellToRORddynClmidFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellToRORddynClmidFromCellMLCvodeOpt>::Initialise(void)
{
