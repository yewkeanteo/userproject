...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellToRORddynClmidFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double CellToRORddynClmidFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    CellToRORddynClmidFromCellMLCvode::CellToRORddynClmidFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                45,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellToRORddynClmidFromCellMLCvode>::Instance();
        Init();

        // We have a default stimulus specified in the CellML file metadata
        this->mHasDefaultStimulusFromCellML = true;
        NV_Ith_S(this->mParameters, 0) = 0.05; // (c,CaMK__CaMKo) [dimensionless]
        NV_Ith_S(this->mParameters, 1) = 1.5378; // (c,ryr__Jrel_b) [dimensionless]
        NV_Ith_S(this->mParameters, 2) = 1.0; // (c,SERCA__Jup_b) [dimensionless]
        NV_Ith_S(this->mParameters, 3) = 0.05; // (c,CaMK__aCaMK) [per_millimolar_per_millisecond]
        NV_Ith_S(this->mParameters, 4) = 8.3757e-05; // (c,ICaL__PCa_b) [dimensionless]
        NV_Ith_S(this->mParameters, 5) = 0.0; // (c,I_katp__fkatp) [dimensionless]
        NV_Ith_S(this->mParameters, 6) = 11.7802; // (c,INa__GNa) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 7) = 0.6992; // (c,IK1__GK1_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 8) = 0.0279; // (c,INaL__GNaL_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 9) = 0.0321; // (c,IKr__GKr_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 10) = 0.0011; // (c,IKs__GKs_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 11) = 0.0034; // (c,INaCa__Gncx_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 12) = 15.4509; // (c,INaK__Pnak_b) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 13) = 0.16; // (c,Ito__Gto_b) [milliS_per_microF]
    }
    
    CellToRORddynClmidFromCellMLCvode::~CellToRORddynClmidFromCellMLCvode()
    {
    }
    
    double CellToRORddynClmidFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_CaMK__CaMKb = (NV_Ith_S(mParameters, 0) * (1.0 - var_chaste_interface__CaMK__CaMKt)) / (1.0 + (0.0015 / var_chaste_interface__intracellular_ions__cass)); // millimolar
        ...
        const double var_INa__INa = NV_Ith_S(mParameters, 6) * (var_chaste_interface__membrane__v - var_reversal_potentials__ENa) * pow(var_chaste_interface__INa__m, 3.0) * (((1.0 - var_INa__fINap) * var_chaste_interface__INa__h * var_chaste_interface__INa__j) + (var_INa__fINap * var_chaste_interface__INa__hp * var_chaste_interface__INa__jp)); // microA_per_microF
        const double var_INaL__fINaLp = 1.0 / (1.0 + (0.14999999999999999 / var_CaMK__CaMKa)); // dimensionless
        const double var_INaL__INaL = NV_Ith_S(mParameters, 8) * (var_chaste_interface__membrane__v - var_reversal_potentials__ENa) * var_chaste_interface__INaL__mL * (((1.0 - var_INaL__fINaLp) * var_chaste_interface__INaL__hL) + (var_INaL__fINaLp * var_chaste_interface__INaL__hLp)); // microA_per_microF
        ...
        const double var_Ito__AiF = 1.0 / (1.0 + exp(((var_chaste_interface__membrane__v + 0.0) - 213.59999999999999) * 0.0066137566137566143)); // dimensionless
        ...
        const double var_ICaL__PCa = NV_Ith_S(mParameters, 4) * 2.0; // dimensionless
        ...
        const double var_ICaL__PhiCaL_ss = (4.0 * var_membrane__vffrt * ((exp(((sqrt(var_ICaL__Iss) / (1.0 + sqrt(var_ICaL__Iss))) - (0.29999999999999999 * var_ICaL__Iss)) *  -2.095276098912819) * var_chaste_interface__intracellular_ions__cass * exp(2.0 * var_membrane__vfrt)) - (var_ICaL__gamma_cao * var_extracellular__cao))) / (exp(2.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaL_i = (4.0 * var_membrane__vffrt * ((var_ICaL__gamma_cai * var_chaste_interface__intracellular_ions__cai * exp(2.0 * var_membrane__vfrt)) - (var_ICaL__gamma_cao * var_extracellular__cao))) / (exp(2.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaNa_ss = (1.0 * var_membrane__vffrt * ((exp(((sqrt(var_ICaL__Iss) / (1.0 + sqrt(var_ICaL__Iss))) - (0.29999999999999999 * var_ICaL__Iss)) *  -0.52381902472820474) * var_chaste_interface__intracellular_ions__nass * exp(1.0 * var_membrane__vfrt)) - (var_ICaL__gamma_nao * var_extracellular__nao))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaNa_i = (1.0 * var_membrane__vffrt * ((exp(((sqrt(var_ICaL__Ii) / (1.0 + sqrt(var_ICaL__Ii))) - (0.29999999999999999 * var_ICaL__Ii)) *  -0.52381902472820474) * var_chaste_interface__intracellular_ions__nai * exp(1.0 * var_membrane__vfrt)) - (var_ICaL__gamma_nao * var_extracellular__nao))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaK_i = (1.0 * var_membrane__vffrt * ((exp(((sqrt(var_ICaL__Ii) / (1.0 + sqrt(var_ICaL__Ii))) - (0.29999999999999999 * var_ICaL__Ii)) *  -0.52381902472820474) * var_chaste_interface__intracellular_ions__ki * exp(1.0 * var_membrane__vfrt)) - (var_ICaL__gamma_ko * var_extracellular__ko))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaK_ss = (1.0 * var_membrane__vffrt * ((exp(((sqrt(var_ICaL__Iss) / (1.0 + sqrt(var_ICaL__Iss))) - (0.29999999999999999 * var_ICaL__Iss)) *  -0.52381902472820474) * var_chaste_interface__intracellular_ions__kss * exp(1.0 * var_membrane__vfrt)) - (var_ICaL__gamma_ko * var_extracellular__ko))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_INaCa__h1_i = 1.0 + ((var_chaste_interface__intracellular_ions__nai * 0.011348161597821153) * (1.0 + var_INaCa__hna)); // dimensionless
        const double var_INaCa__h2_i = (var_chaste_interface__intracellular_ions__nai * var_INaCa__hna) / (88.120000000000005 * var_INaCa__h1_i); // dimensionless
        ...
        const double var_INaCa__h7_i = 1.0 + ((var_extracellular__nao * 0.011348161597821153) * (1.0 + (1.0 / var_INaCa__hna))); // dimensionless
        const double var_INaCa__h8_i = var_extracellular__nao / (88.120000000000005 * var_INaCa__hna * var_INaCa__h7_i); // dimensionless
        ...
        const double var_INaCa__k4_i = (((1.0 / var_INaCa__h1_i) * 60000.0) / var_INaCa__hca) + var_INaCa__k4pp_i; // dimensionless
        ...
        const double var_INaCa__h7_ss = 1.0 + ((var_extracellular__nao * 0.011348161597821153) * (1.0 + (1.0 / var_INaCa__hna))); // dimensionless
        const double var_INaCa__h8_ss = var_extracellular__nao / (88.120000000000005 * var_INaCa__hna * var_INaCa__h7_ss); // dimensionless
        ...
        const double var_INaCa__h1_ss = 1.0 + ((var_chaste_interface__intracellular_ions__nass * 0.011348161597821153) * (1.0 + var_INaCa__hna)); // dimensionless
        const double var_INaCa__h2_ss = (var_chaste_interface__intracellular_ions__nass * var_INaCa__hna) / (88.120000000000005 * var_INaCa__h1_ss); // dimensionless
        ...
        const double var_INaCa__k4_ss = (((1.0 / var_INaCa__h1_ss) * 60000.0) / var_INaCa__hca) + var_INaCa__k4pp_ss; // dimensionless
        ...
        const double var_INaK__Knao = 27.780000000000001 * exp((1.155 * var_membrane__vfrt) * 0.33333333333333331); // millimolar
        ...
        const double var_INaK__Knai = 9.0730000000000004 * exp(( -0.155 * var_membrane__vfrt) * 0.33333333333333331); // millimolar
        ...
        const double var_INaK__INaK = (NV_Ith_S(mParameters, 12) * 0.69999999999999996) * ((1.0 * (3.0 * (((var_INaK__x1 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__a3) - ((var_INaK__x2 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__b3)))) + (1.0 * (2.0 * (((var_INaK__x4 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * 9.120000000000001) - ((var_INaK__x3 / (var_INaK__x1 + var_INaK__x2 + var_INaK__x3 + var_INaK__x4)) * var_INaK__a1))))); // microA_per_microF
        const double var_INab__INab = (1.9238999999999999e-09 * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__nai * exp(var_membrane__vfrt)) - var_extracellular__nao)) / (exp(var_membrane__vfrt) - 1.0); // microA_per_microF
        const double var_IKb__IKb = 0.0189 * (1.0 / (1.0 + exp((-(var_chaste_interface__membrane__v - 10.896800000000001)) * 0.041689074544234192))) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_ICab__ICab = (var_membrane__vffrt * ((var_ICaL__gamma_cai * var_chaste_interface__intracellular_ions__cai * exp(2.0 * var_membrane__vfrt)) - (var_ICaL__gamma_cao * var_extracellular__cao)) * 2.36776e-07) / (exp(2.0 * var_membrane__vfrt) - 1.0); // microA_per_microF
        ...
        const double var_I_katp__I_katp = NV_Ith_S(mParameters, 5) * pow(var_extracellular__ko * 0.20000000000000001, 0.23999999999999999) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK) * 0.066453846153846155; // microA_per_microF
    ...
    void CellToRORddynClmidFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_ryr__Jrel = NV_Ith_S(mParameters, 1) * (((1.0 - var_ryr__fJrelp) * var_chaste_interface__ryr__Jrel_np) + (var_ryr__fJrelp * var_chaste_interface__ryr__Jrel_p)); // millimolar_per_millisecond
        ...
        const double var_INa__hss = 1.0 / pow(1.0 + exp((var_chaste_interface__membrane__v + 71.549999999999997) * 0.13458950201884254), 2.0); // dimensionless
        const double var_INa__th = 1.0 / (((var_chaste_interface__membrane__v >=  -40.0) ? 0.0 : (0.057000000000000002 * exp((-(var_chaste_interface__membrane__v + 80.0)) * 0.14705882352941177))) + ((var_chaste_interface__membrane__v >=  -40.0) ? (0.77000000000000002 / (0.13 * (1.0 + exp((-(var_chaste_interface__membrane__v + 10.66)) * 0.0900900900900901)))) : ((2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__membrane__v)) + (310000.0 * exp(0.34849999999999998 * var_chaste_interface__membrane__v))))); // millisecond
        const double var_INa__jss = var_INa__hss; // dimensionless
        const double var_INa__tj = 1.0 / (((var_chaste_interface__membrane__v >=  -40.0) ? 0.0 : (((( -25428.0 * exp(0.24440000000000001 * var_chaste_interface__membrane__v)) - (6.9480000000000002e-06 * exp( -0.043909999999999998 * var_chaste_interface__membrane__v))) * (var_chaste_interface__membrane__v + 37.780000000000001)) / (1.0 + exp(0.311 * (var_chaste_interface__membrane__v + 79.230000000000004))))) + ((var_chaste_interface__membrane__v >=  -40.0) ? ((0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane__v)) / (1.0 + exp( -0.10000000000000001 * (var_chaste_interface__membrane__v + 32.0)))) : ((0.024240000000000001 * exp( -0.01052 * var_chaste_interface__membrane__v)) / (1.0 + exp( -0.13780000000000001 * (var_chaste_interface__membrane__v + 40.140000000000001)))))); // millisecond
        const double var_Ito__ta = 1.0515000000000001 / ((1.0 / (1.2089000000000001 * (1.0 + exp((-((var_chaste_interface__membrane__v + 0.0) - 18.4099)) * 0.034035137876343539)))) + (3.5 / (1.0 + exp((var_chaste_interface__membrane__v + 100.0) * 0.034035137876343539)))); // millisecond
        ...
        const double var_Ito__dti_develop = 1.3540000000000001 + (0.0001 / (exp(((var_chaste_interface__membrane__v + 0.0) - 167.40000000000001) * 0.062932662051604776) + exp((-((var_chaste_interface__membrane__v + 0.0) - 12.23)) * 4.6425255338904359))); // dimensionless
        ...
        const double var_IKr__alpha_C2ToI = 5.1999999999999997e-05 * exp(1.5249999999999999 * var_membrane__vfrt); // per_millisecond
        const double var_IKr__beta_ItoC2 = (var_IKr__beta_2 * var_IKr__beta_i * var_IKr__alpha_C2ToI) / (var_IKr__alpha_2 * var_IKr__alpha_i); // per_millisecond
        ...
        const double d_dt_chaste_interface__CaMK__CaMKt = (NV_Ith_S(mParameters, 3) * var_CaMK__CaMKb * (var_CaMK__CaMKb + var_chaste_interface__CaMK__CaMKt)) - (0.00068000000000000005 * var_chaste_interface__CaMK__CaMKt); // 'millimole per litre per millisecond'
        ...
        const double d_dt_chaste_interface__INa__m = ((1.0 / pow(1.0 + exp((-(var_chaste_interface__membrane__v + 56.859999999999999)) * 0.11074197120708749), 2.0)) - var_chaste_interface__INa__m) / ((0.12920000000000001 * exp(-pow((var_chaste_interface__membrane__v + 45.789999999999999) * 0.064350064350064351, 2.0))) + (0.064869999999999997 * exp(-pow((var_chaste_interface__membrane__v - 4.8230000000000004) * 0.019561815336463225, 2.0)))); // per_millisecond
        const double d_dt_chaste_interface__INa__h = (var_INa__hss - var_chaste_interface__INa__h) / var_INa__th; // per_millisecond
        const double d_dt_chaste_interface__INa__j = (var_INa__jss - var_chaste_interface__INa__j) / var_INa__tj; // per_millisecond
        const double d_dt_chaste_interface__INa__hp = ((1.0 / pow(1.0 + exp((var_chaste_interface__membrane__v + 77.549999999999997) * 0.13458950201884254), 2.0)) - var_chaste_interface__INa__hp) / var_INa__th; // per_millisecond
        const double d_dt_chaste_interface__INa__jp = (var_INa__jss - var_chaste_interface__INa__jp) / (1.46 * var_INa__tj); // per_millisecond
        const double d_dt_chaste_interface__INaL__mL = ((1.0 / (1.0 + exp((-(var_chaste_interface__membrane__v + 42.850000000000001)) * 0.18996960486322187))) - var_chaste_interface__INaL__mL) / ((0.12920000000000001 * exp(-pow((var_chaste_interface__membrane__v + 45.789999999999999) * 0.064350064350064351, 2.0))) + (0.064869999999999997 * exp(-pow((var_chaste_interface__membrane__v - 4.8230000000000004) * 0.019561815336463225, 2.0)))); // per_millisecond
        ...
        const double d_dt_chaste_interface__Ito__a = ((1.0 / (1.0 + exp((-((var_chaste_interface__membrane__v + 0.0) - 14.34)) * 0.067476383265856948))) - var_chaste_interface__Ito__a) / var_Ito__ta; // per_millisecond
        ...
        const double d_dt_chaste_interface__Ito__ap = ((1.0 / (1.0 + exp((-((var_chaste_interface__membrane__v + 0.0) - 24.34)) * 0.067476383265856948))) - var_chaste_interface__Ito__ap) / var_Ito__ta; // per_millisecond
        ...
        const double d_dt_chaste_interface__ICaL__d = (((var_chaste_interface__membrane__v >= 31.497800000000002) ? 1.0 : (1.0763 * exp( -1.0069999999999999 * exp( -0.082900000000000001 * var_chaste_interface__membrane__v)))) - var_chaste_interface__ICaL__d) / ((1.0 / (exp( -0.050000000000000003 * (var_chaste_interface__membrane__v + 6.0)) + exp(0.089999999999999997 * (var_chaste_interface__membrane__v + 14.0)))) + 0.59999999999999998); // per_millisecond
        ...
        const double d_dt_chaste_interface__ICaL__jca = ((1.0 / (1.0 + exp((var_chaste_interface__membrane__v + 18.079999999999998) * 0.35821750967187277))) - var_chaste_interface__ICaL__jca) * 0.013793103448275862; // per_millisecond
        ...
        const double d_dt_chaste_interface__IKr__C1 = ((0.15437500000000001 * var_chaste_interface__IKr__C2) + (var_IKr__beta_2 * var_chaste_interface__IKr__O) + (var_IKr__beta_ItoC2 * var_chaste_interface__IKr__I)) - ((0.19109999999999999 + var_IKr__alpha_2 + var_IKr__alpha_C2ToI) * var_chaste_interface__IKr__C1); // per_millisecond
        const double d_dt_chaste_interface__IKr__C2 = ((var_IKr__alpha * var_chaste_interface__IKr__C3) + (0.19109999999999999 * var_chaste_interface__IKr__C1)) - ((var_IKr__beta + 0.15437500000000001) * var_chaste_interface__IKr__C2); // per_millisecond
        const double d_dt_chaste_interface__IKr__C3 = (var_IKr__beta * var_chaste_interface__IKr__C2) - (var_IKr__alpha * var_chaste_interface__IKr__C3); // per_millisecond
        const double d_dt_chaste_interface__IKr__I = ((var_IKr__alpha_C2ToI * var_chaste_interface__IKr__C1) + (var_IKr__alpha_i * var_chaste_interface__IKr__O)) - ((var_IKr__beta_ItoC2 + var_IKr__beta_i) * var_chaste_interface__IKr__I); // per_millisecond
        const double d_dt_chaste_interface__IKr__O = ((var_IKr__alpha_2 * var_chaste_interface__IKr__C1) + (var_IKr__beta_i * var_chaste_interface__IKr__I)) - ((var_IKr__beta_2 + var_IKr__alpha_i) * var_chaste_interface__IKr__O); // per_millisecond
        ...
        NV_Ith_S(rDY, 1) = d_dt_chaste_interface__intracellular_ions__cai;
        NV_Ith_S(rDY, 2) = d_dt_chaste_interface__CaMK__CaMKt;
        NV_Ith_S(rDY, 3) = d_dt_chaste_interface__intracellular_ions__nai;
        NV_Ith_S(rDY, 4) = d_dt_chaste_interface__intracellular_ions__nass;
        NV_Ith_S(rDY, 5) = d_dt_chaste_interface__intracellular_ions__ki;
        NV_Ith_S(rDY, 6) = d_dt_chaste_interface__intracellular_ions__kss;
        NV_Ith_S(rDY, 7) = d_dt_chaste_interface__intracellular_ions__cass;
        NV_Ith_S(rDY, 8) = d_dt_chaste_interface__intracellular_ions__cansr;
        NV_Ith_S(rDY, 9) = d_dt_chaste_interface__intracellular_ions__cajsr;
        NV_Ith_S(rDY, 10) = d_dt_chaste_interface__intracellular_ions__cli;
        NV_Ith_S(rDY, 11) = d_dt_chaste_interface__intracellular_ions__clss;
        NV_Ith_S(rDY, 12) = d_dt_chaste_interface__INa__m;
        NV_Ith_S(rDY, 13) = d_dt_chaste_interface__INa__h;
        NV_Ith_S(rDY, 14) = d_dt_chaste_interface__INa__j;
        NV_Ith_S(rDY, 15) = d_dt_chaste_interface__INa__hp;
        NV_Ith_S(rDY, 16) = d_dt_chaste_interface__INa__jp;
        NV_Ith_S(rDY, 17) = d_dt_chaste_interface__INaL__mL;
        NV_Ith_S(rDY, 18) = d_dt_chaste_interface__INaL__hL;
        NV_Ith_S(rDY, 19) = d_dt_chaste_interface__INaL__hLp;
        NV_Ith_S(rDY, 20) = d_dt_chaste_interface__Ito__a;
        NV_Ith_S(rDY, 21) = d_dt_chaste_interface__Ito__iF;
        NV_Ith_S(rDY, 22) = d_dt_chaste_interface__Ito__iS;
        NV_Ith_S(rDY, 23) = d_dt_chaste_interface__Ito__ap;
        NV_Ith_S(rDY, 24) = d_dt_chaste_interface__Ito__iFp;
        NV_Ith_S(rDY, 25) = d_dt_chaste_interface__Ito__iSp;
        NV_Ith_S(rDY, 26) = d_dt_chaste_interface__ICaL__d;
        NV_Ith_S(rDY, 27) = d_dt_chaste_interface__ICaL__ff;
        NV_Ith_S(rDY, 28) = d_dt_chaste_interface__ICaL__fs;
        NV_Ith_S(rDY, 29) = d_dt_chaste_interface__ICaL__fcaf;
        NV_Ith_S(rDY, 30) = d_dt_chaste_interface__ICaL__fcas;
        NV_Ith_S(rDY, 31) = d_dt_chaste_interface__ICaL__jca;
        NV_Ith_S(rDY, 32) = d_dt_chaste_interface__ICaL__ffp;
        NV_Ith_S(rDY, 33) = d_dt_chaste_interface__ICaL__fcafp;
        NV_Ith_S(rDY, 34) = d_dt_chaste_interface__ICaL__nca_ss;
        NV_Ith_S(rDY, 35) = d_dt_chaste_interface__ICaL__nca_i;
        NV_Ith_S(rDY, 36) = d_dt_chaste_interface__IKr__C1;
        NV_Ith_S(rDY, 37) = d_dt_chaste_interface__IKr__C2;
        NV_Ith_S(rDY, 38) = d_dt_chaste_interface__IKr__C3;
        NV_Ith_S(rDY, 39) = d_dt_chaste_interface__IKr__I;
        NV_Ith_S(rDY, 40) = d_dt_chaste_interface__IKr__O;
        NV_Ith_S(rDY, 41) = d_dt_chaste_interface__IKs__xs1;
        NV_Ith_S(rDY, 42) = d_dt_chaste_interface__IKs__xs2;
        NV_Ith_S(rDY, 43) = d_dt_chaste_interface__ryr__Jrel_np;
        NV_Ith_S(rDY, 44) = d_dt_chaste_interface__ryr__Jrel_p;
    }
    
template<>
void OdeSystemInformation<CellToRORddynClmidFromCellMLCvode>::Initialise(void)
{
