...
public:
          ...
          mpStimulus(new SimpleStimulus(-1500e4, 2))
    {
        ...
        std::bernoulli_distribution distribution(0.775);
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Random775ScaledIZ20");
        HeartConfig::Instance()->SetOutputFilenamePrefix("Random775ScaledIZ20");
