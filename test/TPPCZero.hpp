...
public:
     void TestConductionBidomain3D()
	 {
		...
		Hdf5DataReader simulation_data("projects/userproject/Results/1000ms/ZeroConductance2",
                                       "ZerolConductance2", false);

        PropagationPropertiesCalculator ppc(&simulation_data);
		//ppc.CalculateConductionVelocity(middle_index,rhs_index,0.08);
		std::cout << "The zero conduction velocity is "<<ppc.CalculateConductionVelocity(middle_index,rhs_index,0.08) << "\n";
	 }
};
