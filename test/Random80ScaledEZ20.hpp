...
class CustomCellFactory : public AbstractCardiacCellFactory<2> 
{
private:
...
public:
          ...
          mpStimulus(new SimpleStimulus(-0e4, 2))
    {
        ...
        std::bernoulli_distribution distribution(0.80);
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Random80ScaledEZ20");
        HeartConfig::Instance()->SetOutputFilenamePrefix("Random80ScaledEZ20");
        ...
        double magnitude = -15.0e3; // uA/cm^2
