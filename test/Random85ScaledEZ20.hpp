...
public:
          ...
          mpStimulus(new SimpleStimulus(-0e4, 2))
    {
        ...
        std::bernoulli_distribution distribution(0.85);
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Random85ScaledEZ20");
        HeartConfig::Instance()->SetOutputFilenamePrefix("Random85ScaledEZ20");
