...
public:
	 ...
	 {
		unsigned lhs_index = 1005;
        unsigned rhs_index = 1020;
		...
		Hdf5DataReader simulation_data("projects/userproject/Results/100ms/ScaledIN2BCB100",
                                       "ScaledIN2BCB100", false);
        PropagationPropertiesCalculator ppc(&simulation_data);
		//ppc.CalculateConductionVelocity(middle_index,rhs_index,0.1);
		std::cout << "The normal conduction velocity between Node 1005 and Node 1020 is "<<ppc.CalculateConductionVelocity(lhs_index,rhs_index,0.0075) << "\n";
