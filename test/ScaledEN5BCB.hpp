...
public:
    CustomCellFactory()
        : AbstractCardiacCellFactory<2>(), 
          mpStimulus(new SimpleStimulus(-1200e4, 2))
    {
    }
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        double h=0.0005;
        mesh.ConstructRegularSlabMesh(h, 0.0675 /*length*/, 0.016 /*width*/);
        HeartConfig::Instance()->SetOutputUsingOriginalNodeOrdering(true);
        HeartConfig::Instance()->SetSimulationDuration(100.0);  //ms
        HeartConfig::Instance()->SetOutputDirectory("ScaledEN5BCB100");
        HeartConfig::Instance()->SetOutputFilenamePrefix("ScaledEN5BCB100");
