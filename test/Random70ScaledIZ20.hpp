...
public:
          ...
          mpStimulus(new SimpleStimulus(-1500e4, 2))
    {
        ...
        std::bernoulli_distribution distribution(0.70);
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Random70ScaledIZ20");
        HeartConfig::Instance()->SetOutputFilenamePrefix("Random70ScaledIZ20");
