...
public:
          ...
          mpStimulus(new SimpleStimulus(-0e4, 2))
    {
        ...
        std::bernoulli_distribution distribution(0.90);
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Random90ScaledEZ20");
        HeartConfig::Instance()->SetOutputFilenamePrefix("Random90ScaledEZ20");
