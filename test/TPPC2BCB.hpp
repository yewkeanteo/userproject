...
public:
	 ...
	 {
		unsigned lhs_index = 429;
        unsigned rhs_index = 439;
		...
		Hdf5DataReader simulation_data("projects/userproject/Results/Intra2BCB/IntraZero2BCB1000",
                                       "IntraZero2BCB1000", false);
        PropagationPropertiesCalculator ppc(&simulation_data);
		//ppc.CalculateConductionVelocity(middle_index,rhs_index,0.1);
		std::cout << "The normal conduction velocity between Node 429 and Node 439 is "<<ppc.CalculateConductionVelocity(lhs_index,rhs_index,0.2) << "\n";
