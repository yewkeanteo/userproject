...
public:
          ...
          mpStimulus(new SimpleStimulus(-0e4, 2))
    {
        ...
        std::bernoulli_distribution distribution(0.875);
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Random875ScaledEZ20");
        HeartConfig::Instance()->SetOutputFilenamePrefix("Random875ScaledEZ20");
