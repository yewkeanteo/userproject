...
public:
	 ...
	 {
		unsigned lhs_index = 529;
        unsigned rhs_index = 549;
		...
		Hdf5DataReader simulation_data("projects/userproject/Results/Intra3Cell/IntraZero3BCB1000",
                                       "IntraZero3BCB1000", false);
        PropagationPropertiesCalculator ppc(&simulation_data);
		//ppc.CalculateConductionVelocity(middle_index,rhs_index,0.1);
		std::cout << "The normal conduction velocity between Node 529 and Node 549 is "<<ppc.CalculateConductionVelocity(lhs_index,rhs_index,0.4) << "\n";
