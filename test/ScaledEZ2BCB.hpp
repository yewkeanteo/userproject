...
public:
    ...
    AbstractCvodeCell* CreateCardiacCellForTissueNode(Node<2>* pNode)
    {
        ...
        double y = pNode->rGetLocation()[1];
         if ((x<0.008+1e-6) && (y<0.009+1e-6))
			{
			if ((x>0.0075+1e-6) && (y>0.0085+1e-6))
				{
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("ScaledEZ2BCB1000");
        HeartConfig::Instance()->SetOutputFilenamePrefix("ScaledEZ2BCB1000");
        ...
        double magnitude = -38.5e3; // uA/cm^2
