...
public:
          ...
          mpStimulus(new SimpleStimulus(-0e4, 2))
    {
        ...
        std::bernoulli_distribution distribution(0.925);
...
public: // Tests should be public!
    ...
    void TestWithBathAndElectrodes()
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Random925ScaledEZ20");
        HeartConfig::Instance()->SetOutputFilenamePrefix("Random925ScaledEZ20");
