...
public:
	 ...
	 {
		unsigned lhs_index = 423;
        unsigned rhs_index = 433;
		...
		Hdf5DataReader simulation_data("projects/userproject/Results/DoubleCell/NormalDoubleCell1000",
                                       "NormalDoubleCell1000", false);
        PropagationPropertiesCalculator ppc(&simulation_data);
		//ppc.CalculateConductionVelocity(middle_index,rhs_index,0.1);
		std::cout << "The normal conduction velocity between Node 423 and Node 433 is "<<ppc.CalculateConductionVelocity(lhs_index,rhs_index,0.2) << "\n";
