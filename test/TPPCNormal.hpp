...
public:
     void TestConductionBidomain3D()
	 {
		...
		Hdf5DataReader simulation_data("projects/userproject/Results/500msdelay/NormalConductance0.001ode0.001pde0.1print",
                                       "NormalConductance0.001ode0.001pde0.1print", false);
